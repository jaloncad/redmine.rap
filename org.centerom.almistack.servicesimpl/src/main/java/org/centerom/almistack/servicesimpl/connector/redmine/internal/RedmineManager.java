...
import org.centerom.almistack.servicesimpl.connector.redmine.internal.beans.Group;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.beans.Identifiable;
...
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.handlers.CopyBytesHandler;
...
import org.centerom.almistack.servicesimpl.connector.redmine.internal.io.MarkedIOException;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.io.MarkedInputStream;
...
public class RedmineManager {
    ...
    private static final String TRACKER_ID_PARAM = "tracker_id";
    ...
    /**
     * Delivers an {@link org.centerom.almistack.domain.internal.redmine.taskadapter.redmineapi.bean.Attachment} by its ID.
     *
     * @param attachmentID the ID
     * @return the {@link org.centerom.almistack.domain.internal.redmine.taskadapter.redmineapi.bean.Attachment}
     * @throws RedmineAuthenticationException thrown in case something went wrong while trying to login
     * @throws RedmineException        thrown in case something went wrong in Redmine
     * @throws NotFoundException       thrown in case an object can not be found
     */
    ...
    /**
     * Downloads the content of an {@link org.centerom.almistack.domain.internal.redmine.taskadapter.redmineapi.bean.Attachment} from the Redmine server.
     *
     * @param issueAttachment the {@link org.centerom.almistack.domain.internal.redmine.taskadapter.redmineapi.bean.Attachment}
...
/*	
	public List<String> getStates() throws RedmineException {
		List<NameValuePair>	params = new ArrayList<NameValuePair>();

		List<IssueStatus> tmp = transport.getObjectsList(IssueStatus.class, params);
...
*/
    ...
    public List<News> getNews(Integer projectId) throws RedmineException {
        return transport.getObjectsList(News.class,
        								new BasicNameValuePair(PROJECT_ID_PARAM,
        													   projectId.toString()));
    }

	/**
	 * Retrieves the Redmine project which database id is <projectId>.
	 * 
	 * @param projectId database numeric Id
	 * @return Redmine's project
	 * @throws RedmineException the Redmine exception
	 */
	public Project getProjectById(Integer projectId) throws RedmineException {
		return transport.getObject(Project.class,
								   projectId,
								   new BasicNameValuePair("include", "trackers"));
    }

	/**
	 * Retrieves the issues list of Redmine project which database id is <projectId>.
	 * 
	 * @param projectId database numeric Id 
	 * @return list of Issue objects
	 * @throws RedmineException the Redmine exception
	 */
    public List<Issue> getIssuesByProjectId(Integer projectId) throws RedmineException {
    	// Locals
    	List<NameValuePair>	params = new ArrayList<NameValuePair>();

        if (projectId != null) {
            params.add(new BasicNameValuePair(PROJECT_ID_PARAM, projectId.toString()));
        }
    ...
    public List<Issue> getIssuesByProjectId(Integer projectId,
        ...
        includeStr = Joiner.join(",", include);
        params.add(new BasicNameValuePair(INCLUDE_PARAM, includeStr));
    ...
    /**
     * Retrieves the issues list (according with its type which id is <trackId>)
     * of Redmine project which database id is <projectId>
     * 
     * @param projectId database numeric Id
     * @param trackId database numeric Id
     * @return list of Issue objects
     * @throws RedmineException
     */
    public List<Issue> getProjectIssuesByTrack(Integer projectId,
    										   Integer trackId) 
    									throws RedmineException {
		// Locals
    	List<NameValuePair> params = new ArrayList<NameValuePair>();
    	...
    	try {
    		params.add(new BasicNameValuePair(PROJECT_ID_PARAM, projectId.toString()));
        	params.add(new BasicNameValuePair(TRACKER_ID_PARAM, trackId.toString()));
    ...
    public List<Issue> getIssuesByTrack(Integer trackId,
    ...
    public List<Issue> getProjectIssuesByTrack(Integer projectId,
		...
		List<NameValuePair>
				   params = new ArrayList<NameValuePair>();
		String includeStr = Joiner.join(COMMA, include);
	...
	public Tracker getTrackerName(Integer trackerId) throws RedmineException {
		/*
		Object st = (Object) transport.getObject(Tracker.class,
								   trackerId,
								   new BasicNameValuePair("id", trackerId.toString()));
		
		return null;
		*/
		try {
			return transport.getObject(Tracker.class,
					trackerId,
					   new BasicNameValuePair("include", "trackers"));	
		}
		catch (Exception e) {
...
/*    
    ...
    public IssueRelation getRelations(Integer issueId, Integer issueToId, String type) throws RedmineException {
    	// Locals
    	List<NameValuePair> params = new ArrayList<NameValuePair>();
        ...
        params.add(new BasicNameValuePair(PROJECT_ID_PARAM, issueId.toString()));

    	
        return transport.getObjectsList(IssueRelation.class, params);
