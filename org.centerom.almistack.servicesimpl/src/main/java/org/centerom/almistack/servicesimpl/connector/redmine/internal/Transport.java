...
import org.centerom.almistack.core.ConfigurationUtil;
...
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.BaseCommunicator;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.BasicHttpResponse;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.Communicator;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.Communicators;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.RedmineAuthenticator;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.SimpleCommunicator;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.handlers.ContentHandler;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.comm.handlers.RedmineErrorHandler;
...
import org.centerom.almistack.servicesimpl.connector.redmine.internal.json.JsonInput;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.json.JsonObjectParser;
import org.centerom.almistack.servicesimpl.connector.redmine.internal.json.JsonObjectWriter;
...
public final class Transport {
	...
	public <T> List<T> getObjectsList(Class<T> objectClass,
		...
		do {
			...
			// TODO
			// 
//			ConfigurationUtil.initialize(null, null);
//			ConfigurationUtil.getInstance().configureLog();
	...
	private static <T> T parseResponse(String response, String tag,
		...
		try {
			return (T) parser.parse(RedmineJSONParser.getResponseSingleObject(response, tag));
		} catch (JSONException e) {
			throw new RedmineFormatException(e);
		}
	}
